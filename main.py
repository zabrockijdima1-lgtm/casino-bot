...
NFT_CATALOG = [
    ...
    {"id":"santahat","name":"Santa Hat","floor":1.20,"price":1.26,"rarity":"Common","color":"#0d2e1a"},
    {"id":"moussecake","name":"Mousse Cake","floor":1.30,"price":1.37,"rarity":"Common","color":"#0d2e1a"},
    {"id":"lolpop2","name":"Lol Pop","floor":1.40,"price":1.47,"rarity":"Common","color":"#0d2e1a"},
    {"id":"instantramen","name":"Instant Ramen","floor":1.50,"price":1.58,"rarity":"Common","color":"#0d2e1a"},
    {"id":"springbasket","name":"Spring Basket","floor":1.60,"price":1.68,"rarity":"Common","color":"#0d2e1a"},
    {"id":"homemadecake","name":"Homemade Cake","floor":1.70,"price":1.79,"rarity":"Common","color":"#0d2e1a"},
    {"id":"restlessjar","name":"Restless Jar","floor":1.80,"price":1.89,"rarity":"Common","color":"#0d2e1a"},
    {"id":"witchhat","name":"Witch Hat","floor":1.90,"price":2.00,"rarity":"Common","color":"#0d2e1a"},
    {"id":"chillflame","name":"Chill Flame","floor":2.00,"price":2.10,"rarity":"Common","color":"#0d2e1a"},
    {"id":"xmasstocking","name":"Xmas Stocking","floor":2.10,"price":2.21,"rarity":"Common","color":"#0d2e1a"},
    {"id":"vicecream","name":"Vice Cream","floor":2.20,"price":2.31,"rarity":"Common","color":"#0d2e1a"},
    {"id":"snakebox","name":"Snake Box","floor":2.30,"price":2.42,"rarity":"Common","color":"#0d2e1a"},
    {"id":"candycane","name":"Candy Cane","floor":2.40,"price":2.52,"rarity":"Common","color":"#0d2e1a"},
    {"id":"lunarsnak","name":"Lunar Snake","floor":2.50,"price":2.63,"rarity":"Common","color":"#0d2e1a"},
    {"id":"holidaydrink","name":"Holiday Drink","floor":2.60,"price":2.73,"rarity":"Common","color":"#0d2e1a"},
    {"id":"whipcupcake","name":"Whip Cupcake","floor":2.70,"price":2.84,"rarity":"Common","color":"#0d2e1a"},
    {"id":"winterwreath","name":"Winter Wreath","floor":2.80,"price":2.94,"rarity":"Common","color":"#0d2e1a"},
    {"id":"bigyear","name":"Big Year","floor":2.90,"price":3.05,"rarity":"Common","color":"#0d2e1a"},
    {"id":"poolfloat","name":"Pool Float","floor":3.00,"price":3.15,"rarity":"Common","color":"#0d2e1a"},
    {"id":"joyfulbundle2","name":"Joyful Bundle","floor":3.10,"price":3.26,"rarity":"Common","color":"#0d2e1a"},
    {"id":"jesterhat","name":"Jester Hat","floor":3.20,"price":3.36,"rarity":"Common","color":"#0d2e1a"},
    {"id":"petsnake","name":"Pet Snake","floor":3.30,"price":3.47,"rarity":"Common","color":"#0d2e1a"},
    {"id":"partysparker","name":"Party Sparkler","floor":3.40,"price":3.57,"rarity":"Common","color":"#0d2e1a"},
    {"id":"hypnolollipop","name":"Hypno Lollipop","floor":3.50,"price":3.68,"rarity":"Common","color":"#0d2e1a"},
    {"id":"tamagadget","name":"Tama Gadget","floor":3.60,"price":3.78,"rarity":"Common","color":"#0d2e1a"},
    {"id":"freshsocks","name":"Fresh Socks","floor":3.70,"price":3.89,"rarity":"Common","color":"#0d2e1a"},
    {"id":"jackinthebox","name":"Jack-in-the-Box","floor":3.80,"price":3.99,"rarity":"Common","color":"#0d2e1a"},
    {"id":"easteregg","name":"Easter Egg","floor":3.90,"price":4.10,"rarity":"Common","color":"#0d2e1a"},
    {"id":"spicedwine","name":"Spiced Wine","floor":4.00,"price":4.20,"rarity":"Common","color":"#0d2e1a"},
    {"id":"happybroom","name":"Happy Brownie","floor":4.10,"price":4.31,"rarity":"Common","color":"#0d2e1a"},
    {"id":"lolpop","name":"Lol Pop","floor":4.20,"price":4.41,"rarity":"Common","color":"#0d2e1a"},
    {"id":"stellarrocket","name":"Stellar Rocket","floor":4.30,"price":4.52,"rarity":"Common","color":"#0d2e1a"},
    {"id":"jellybunny","name":"Jelly Bunny","floor":4.40,"price":4.62,"rarity":"Common","color":"#0d2e1a"},
    {"id":"moodpack","name":"Mood Pack","floor":4.50,"price":4.73,"rarity":"Common","color":"#0d2e1a"},
    {"id":"starnotepad","name":"Star Notepad","floor":4.60,"price":4.83,"rarity":"Common","color":"#0d2e1a"},
    {"id":"gingercookie","name":"Ginger Cookie","floor":4.70,"price":4.94,"rarity":"Common","color":"#0d2e1a"},
    {"id":"bunnymuffin","name":"Bunny Muffin","floor":4.80,"price":5.04,"rarity":"Common","color":"#0d2e1a"},
    {"id":"cookieheart","name":"Cookie Heart","floor":4.90,"price":5.14,"rarity":"Common","color":"#0d2e1a"},
    {"id":"snowglobe","name":"Snow Globe","floor":5.00,"price":5.25,"rarity":"Common","color":"#0d2e1a"},
    {"id":"hexpot","name":"Hex Pot","floor":5.10,"price":5.35,"rarity":"Common","color":"#0d2e1a"},
    {"id":"bdaycandle","name":"B-Day Candle","floor":5.20,"price":5.46,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"bowtie","name":"Bow Tie","floor":5.30,"price":5.56,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"cloverpin","name":"Clover Pin","floor":5.40,"price":5.67,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"faithamulet","name":"Faith Amulet","floor":5.50,"price":5.77,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"snowmittens","name":"Snow Mittens","floor":5.60,"price":5.88,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"moonpencil","name":"Moon Pendant","floor":5.70,"price":5.98,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"lushbouquet","name":"Lush Bouquet","floor":5.80,"price":6.09,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"inputkey","name":"Input Key","floor":5.90,"price":6.19,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"timelessbook","name":"Timeless Book","floor":6.00,"price":6.30,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"spyagaric","name":"Spy Agaric","floor":6.10,"price":6.40,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"snoopdog","name":"Snoop Dogg","floor":6.20,"price":6.51,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"joyfullbundle","name":"Joyful Bundle","floor":6.30,"price":6.61,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"lightsword","name":"Light Sword","floor":6.40,"price":6.72,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"eternalcandle","name":"Eternal Candle","floor":6.50,"price":6.82,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"deskcalendar","name":"Desk Calendar","floor":6.60,"price":6.93,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"jollychimp","name":"Jolly Chimp","floor":6.70,"price":7.03,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"swagbag","name":"Swag Bag","floor":6.80,"price":7.14,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"evileye","name":"Evil Eye","floor":6.90,"price":7.24,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"sleighbell","name":"Sleigh Bell","floor":7.00,"price":7.35,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"berrybox","name":"Berry Box","floor":7.10,"price":7.45,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"hangingstar","name":"Hanging Star","floor":7.20,"price":7.56,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"jinglebells","name":"Jingle Bells","floor":7.30,"price":7.66,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"valentinebox","name":"Valentine Box","floor":7.40,"price":7.77,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"lovecandle","name":"Love Candle","floor":7.50,"price":7.87,"rarity":"Rare","color":"#0d1e3a"},
    {"id":"crystalball","name":"Crystal Ball","floor":7.60,"price":7.98,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"skullflower","name":"Skull Flower","floor":7.70,"price":8.08,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"flyingbroom","name":"Flying Broom","floor":7.80,"price":8.19,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"tophat","name":"Top Hat","floor":7.90,"price":8.29,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"sakuraflower","name":"Sakura Flower","floor":8.00,"price":8.40,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"madpumpkin","name":"Mad Pumpkin","floor":8.10,"price":8.50,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"lovepotion","name":"Love Potion","floor":8.20,"price":8.61,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"snoopcigar","name":"Snoop Cigar","floor":8.30,"price":8.71,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"trappedheart","name":"Trapped Heart","floor":8.40,"price":8.82,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"skystillettos","name":"Sky Stilettos","floor":8.50,"price":8.92,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"ionicdryer","name":"Ionic Dryer","floor":8.60,"price":9.03,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"recordplayer","name":"Record Player","floor":8.70,"price":9.13,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"signetring","name":"Signet Ring","floor":8.80,"price":9.24,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"cupidcharm","name":"Cupid Charm","floor":8.90,"price":9.34,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"vintagecigar","name":"Vintage Cigar","floor":9.00,"price":9.45,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"bondedring","name":"Bonded Ring","floor":9.10,"price":9.55,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"sharptongue","name":"Sharp Tongue","floor":9.20,"price":9.66,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"eternalrose","name":"Eternal Rose","floor":9.30,"price":9.76,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"electricskull","name":"Electric Skull","floor":9.40,"price":9.87,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"diamondring","name":"Diamond Ring","floor":9.50,"price":9.97,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"voodoodoll","name":"Voodoo Doll","floor":9.60,"price":10.08,"rarity":"Epic","color":"#1e0d3a"},
    {"id":"toybear","name":"Toy Bear","floor":9.70,"price":10.18,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"nekohelmet","name":"Neko Helmet","floor":9.80,"price":10.29,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"lowrider","name":"Low Rider","floor":9.90,"price":10.39,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"genielamp","name":"Genie Lamp","floor":10.00,"price":10.50,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"swisswatch","name":"Swiss Watch","floor":10.10,"price":10.60,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"kissedfrog","name":"Kissed Frog","floor":10.20,"price":10.71,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"nailbracelet","name":"Nail Bracelet","floor":10.30,"price":10.81,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"gemsignet","name":"Gem Signet","floor":10.40,"price":10.92,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"magicpotion","name":"Magic Potion","floor":10.50,"price":11.02,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"artisanbread","name":"Artisan Brick","floor":10.60,"price":11.13,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"iongem","name":"Ion Gem","floor":10.70,"price":11.23,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"perfumebottle","name":"Perfume Bottle","floor":10.80,"price":11.34,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"westsideside","name":"Westside Sign","floor":10.90,"price":11.44,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"minioscal","name":"Mini Oscar","floor":11.00,"price":11.55,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"lootbag","name":"Loot Bag","floor":11.10,"price":11.65,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"mightyarm","name":"Mighty Arm","floor":11.20,"price":11.76,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"scaredcat","name":"Scared Cat","floor":11.30,"price":11.86,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"heroichelmet","name":"Heroic Helmet","floor":11.40,"price":11.97,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"astralshard","name":"Astral Shard","floor":11.50,"price":12.07,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"preciouspeach","name":"Precious Peach","floor":11.60,"price":12.18,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"durovscap","name":"Durov Cap","floor":11.70,"price":12.28,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"heartlocket","name":"Heart Locket","floor":11.80,"price":12.39,"rarity":"Legendary","color":"#2e1e00"},
    {"id":"plushpepe","name":"Plush Pepe","floor":11.90,"price":12.49,"rarity":"Legendary","color":"#2e1e00"}
]

def get_nft_for_win(win: float):
    if win < 1.1: return None  # NFT падають від 1.1 TON
